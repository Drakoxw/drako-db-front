    ...
    return (
      <tbody id="clientes-tabla">
        <tr id="tr">
          ...
          <th key={`1w`}>{clientes[x-1].Telefono}</th>
          ...
          <div className="btn-group" aria-label="Basic Example">
            <Boton tipo="editar" onClick={editarEntidad} id={clientes[x-1]._id} persona={clientes[x-1].Nombre} />
          </div>
          </th>
        </tr> 
        ...
        <tr id="tr">
          ...
          <th key={`1w`}>{clientes[x-2].Telefono}</th>
          ...
          <th key={`1w-`}>
          <div className="btn-group" aria-label="Basic Example">
            <Boton tipo="editar" onClick={editarEntidad} id={clientes[x-2]._id} persona={clientes[x-2].Nombre}  />
          </div>
          </th>
        </tr> 
        ...
        <tr id="tr">
          ...
          <th key={`1w`}>{clientes[x-3].Telefono}</th>
          ...
          <th key={`1w-`}>
          <div className="btn-group" aria-label="Basic Example">
            <Boton tipo="editar" onClick={editarEntidad} id={clientes[x-3]._id} persona={clientes[x-3].Nombre}  />
          </div>
          </th>
        </tr> 
